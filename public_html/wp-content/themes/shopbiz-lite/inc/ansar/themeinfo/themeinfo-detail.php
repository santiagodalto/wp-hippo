...
class shopbiz_Admin {
	...
	public function __construct() {
		...
		/* activation notice */
		add_action( 'load-themes.php', array( $this, 'shopbiz_activation_admin_notice' ) );
	}
	...
	public function shopbiz_activation_admin_notice() {
		global $pagenow;

		if ( is_admin() && ('themes.php' == $pagenow) && isset( $_GET['activated'] ) ) {
			add_action( 'admin_notices', array( $this, 'shopbiz_admin_notice' ), 99 );
		}
	}
	 ...
	 * @sfunctionse 1.8.2.4
	 */
	public function shopbiz_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Shopbiz Lite! 
For the best use of Shopbiz Lite theme, visit the Wecome page %swelcome page%s.', 'shopbiz' ), '<a href="' . esc_url( admin_url( 'themes.php?page=shopbiz-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=shopbiz-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with Shopbiz Lite', 'shopbiz' ); ?></a></p>
			</div>
		<?php
	}
		...
		<div class="wrap about-wrap">
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					...
					<div class="col">
						<h3><?php esc_html_e( 'Home Page Section Widget', 'shopbiz' ); ?></h3>
						<p><?php esc_html_e( 'Homepage Section Widget like: Shopbiz Service Widget availbale: -  Appearance &#8594; Widgets', 'shopbiz' ) ?></p>
						<p><a href="<?php echo admin_url( 'widgets.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Widgets', 'shopbiz' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p>
							<a href="<?php echo esc_url( 'http://translate.wordpress.org/projects/wp-themes/shopbiz-lite' ); ?>" class="button button-secondary">
								<?php
								esc_html_e( 'Translate', 'shopbiz' );
								echo ' ' . $theme->display( 'Name' );
								?>
